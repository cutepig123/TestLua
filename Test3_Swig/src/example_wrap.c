...
static int _wrap_sort_int(lua_State* L) {
  int SWIG_arg = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("sort_int",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sort_int",1,"int *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("sort_int",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("sort_int",1,SWIGTYPE_p_int);
  }
...
static int _wrap_sort_double(lua_State* L) {
  int SWIG_arg = 0;
  double *arg1 = (double *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("sort_double",1,1)
  arg1 = SWIG_get_double_num_array_var(L,1,&arg2);
  if (!arg1) SWIG_fail;
  sort_double(arg1,arg2);
  
  SWIG_write_double_num_array(L,arg1,arg2); SWIG_arg++; 
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "sort_int", _wrap_sort_int},
    { "sort_double", _wrap_sort_double},
    {0,0}
};
